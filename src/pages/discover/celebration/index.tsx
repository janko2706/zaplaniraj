...
import { celebrationCategories } from "~/utils/celebrationCategories";
...
function Index() {
  ...
  const {
    ...
    categories: celebrationCategories({ replace, iconClasses: "h-5 w-5" }),
  });
  ...
  useEffect(() => {
    setSelectedCategory(
      celebrationCategories({ replace, iconClasses: "h-5 w-5" }).find(
